      ...
      >
        <Toolbar>
          ...
          <Typography 
            ...
            component="div"
          >
            سیستم مدیریت کلینیک - پنل عینک‌ساز
          </Typography>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            >
              <MenuItem onClick={handleNotificationsClose}>سفارش جدید عینک</MenuItem>
              <MenuItem onClick={handleNotificationsClose}>موجودی محصول کم شده است</MenuItem>
              <Divider />
      ...
      >
        ...
        <Box sx={{ overflow: 'auto', mt: 2, px: 2 }}>
          <Box sx={{ 
            ...
            <Typography variant="h6" fontWeight="bold">{user?.username || 'عینک‌ساز'}</Typography>
            <Typography variant="body2" color="text.secondary">{user?.email || 'optician@example.com'}</Typography>
          </Box>
