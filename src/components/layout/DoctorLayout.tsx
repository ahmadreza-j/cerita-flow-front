      ...
      >
        <Toolbar>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            >
              <MenuItem onClick={handleNotificationsClose}>بیمار جدید</MenuItem>
              <MenuItem onClick={handleNotificationsClose}>نوبت ساعت 15:30</MenuItem>
              <MenuItem onClick={handleNotificationsClose}>نتایج آزمایش آماده است</MenuItem>
              <Divider />
      ...
      >
        ...
        <Box sx={{ overflow: 'auto', mt: 2, px: 2 }}>
          <Box sx={{ 
            ...
            <Typography variant="h6" fontWeight="bold">{user?.username || 'دکتر'}</Typography>
            <Typography variant="body2" color="text.secondary">{user?.email || 'doctor@example.com'}</Typography>
          </Box>
