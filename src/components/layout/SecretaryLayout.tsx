            ...
            >
                <Toolbar>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        >
                            <MenuItem onClick={handleNotificationsClose}>نوبت جدید ثبت شد</MenuItem>
                            <MenuItem onClick={handleNotificationsClose}>یادآوری ویزیت ساعت 14:00</MenuItem>
                            <Divider />
            ...
            >
                ...
                <Box sx={{ overflow: 'auto', mt: 2, px: 2 }}>
                    <Box sx={{ 
                        ...
                        <Typography variant="h6" fontWeight="bold">{user?.username || 'منشی'}</Typography>
                        <Typography variant="body2" color="text.secondary">{user?.email || 'secretary@example.com'}</Typography>
                    </Box>
